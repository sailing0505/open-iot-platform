package com.open.iot.eureka.listener;
...
/**
 * 
* @ClassName: EurekaInstanceCanceledListener 
* @Description: 用于监听eureka服务停机通知
* @author huy
* @date 2019年6月15日 上午10:29:56 
*
 */
@Configuration
public class EurekaInstanceCanceledListener implements ApplicationListener {
    ...
    public void onApplicationEvent(ApplicationEvent applicationEvent) {
            ...
            applications.getRegisteredApplications().forEach((registeredApplication) -> {
                registeredApplication.getInstances().forEach((instance) -> {
                    if (instance.getInstanceId().equals(event.getServerId())) {
                        log.debug("服务：" + instance.getAppName() + " 挂了。。。");
        ...
        if (applicationEvent instanceof EurekaInstanceRegisteredEvent) {
            ...
            log.debug("服务：" + event.getInstanceInfo().getAppName() + " 注册成功了。。。");
        }
